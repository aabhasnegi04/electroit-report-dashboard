...
const COLORS = ['#8b5cf6', '#06b6d4', '#10b981', '#f59e0b', '#ef4444', '#ec4899', '#6366f1', '#22c55e']

export default function CollectionByPersonCharts({ data }) {
            ...
            <Box sx={{ width: '100%', overflowX: 'auto', overflowY: 'hidden', WebkitOverflowScrolling: 'touch', p: { xs: 2, md: 2.5 } }}>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={sortedByAmount} margin={{ top: 10, right: 10, left: 10, bottom: 80 }}>
                  ...
                  />
                  <Bar dataKey="amount" fill="#8b5cf6" radius={[8, 8, 0, 0]} stroke="#8b5cf6" strokeWidth={2}>
                    <LabelList 
                      dataKey="amount" 
                      position="top" 
                      formatter={(value) => `₹${(value / 1000).toFixed(0)}K`}
                      style={{ fill: '#8b5cf6', fontWeight: 'bold', fontSize: 12 }} 
                    />
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
